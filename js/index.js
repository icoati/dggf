    ...
    option = {
        ...
        xAxis: [
            {
                ...
                type: 'category',
                // 使用 data 中的数据设为刻度文字
                data: ['北京', '天津', '湖北', '山东', '河北', '福建', '海南', '辽宁', '江西', '厦门', '青岛', '贵州', '重庆'],
                // 刻度设置
                axisTick: {
                    // true意思：图形在刻度中间
                    // false意思：图形在刻度之间
        ...
        series: [

            {
                ...
                barWidth: '60%',
                // 数据
                data: [2100, 1900, 1700, 1560, 1400, 1200, 1000, 950, 900, 750, 600, 480, 240]
            }
        ]
    };
...
(function () {
    var data = {
        day365: { orders: '25862', amount: '13865' },
        day90: { orders: '6536', amount: '3612' },
        day30: { orders: '1987', amount: '1230' },
        day1: { orders: '358', amount: '265' }
    }
    //点击事件
